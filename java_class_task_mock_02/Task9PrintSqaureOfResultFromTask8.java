...
public class Task9PrintSqaureOfResultFromTask8 {
	...
	int sumMultiple1 = 0;
	int sumMultiple2 = 0;
	int sumMultiplePairs = 0;
	int squareSumMultiplePairs = 0;
	...
	sumMultiplePairs = sumMultiple1 + sumMultiple2;

	squareSumMultiplePairs = sumMultiplePairs * sumMultiplePairs;

	System.out.print(" "  +squareSumMultiplePairs);
